...
from week8.agents.specialist_agent import SpecialistAgent
from week8.agents.frontier_agent import FrontierAgent
from week8.agents.neural_network_agent import NeuralNetworkAgent
...
class EnsembleAgent(Agent):
    ...
    def price(self, description: str) -> float:
        ...
        """
        self.log("Running Ensemble Agent - preprocesing text")
