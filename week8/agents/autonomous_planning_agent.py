...
from week8.agents.deals import Deal, Opportunity
from week8.agents.scanner_agent import ScannerAgent
from week8.agents.ensemble_agent import EnsembleAgent
from week8.agents.messaging_agent import MessagingAgent
from openai import AzureOpenAI
from App.config import api_version, azure_endpoint, headers
import os
    ...
    def plan(self, memory: List[str] = []) -> Optional[Opportunity]:
        ...
        while not done:
            response = self.openai.chat.completions.create(
                model=self.MODEL, messages=messages, extra_headers=headers, tools=self.get_tools()
            )
